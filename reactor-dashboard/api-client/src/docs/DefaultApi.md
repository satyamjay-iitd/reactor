...
```typescript
import { DefaultApi, Configuration, RemoteActorInfo } from './api';
...
const { status, data } = await apiInstance.actorAdded(remoteActorInfo);
```
...
```typescript
import { DefaultApi, Configuration, RegistrationArgs } from './api';
...
const { status, data } = await apiInstance.registerLib(registrationArgs);
```
...
```typescript
import { DefaultApi, Configuration, SpawnArgs } from './api';
...
const { status, data } = await apiInstance.startActor(spawnArgs);
```
