...
pub async fn set_duplication(configuration: &configuration::Configuration, msg_duplication_request: models::MsgDuplicationRequest) -> Result<(), Error<SetDuplicationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn set_msg_delay(configuration: &configuration::Configuration, msg_delay_request: models::MsgDelayRequest) -> Result<(), Error<SetMsgDelayError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn set_msg_loss(configuration: &configuration::Configuration, msg_loss_request: models::MsgLossRequest) -> Result<(), Error<SetMsgLossError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn stop_actor(configuration: &configuration::Configuration, body: &str) -> Result<(), Error<StopActorError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn unset_msg_delay(configuration: &configuration::Configuration, disable_msg_delay_request: models::DisableMsgDelayRequest) -> Result<(), Error<UnsetMsgDelayError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn unset_msg_duplication(configuration: &configuration::Configuration, body: &str) -> Result<(), Error<UnsetMsgDuplicationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn unset_msg_loss(configuration: &configuration::Configuration, body: &str) -> Result<(), Error<UnsetMsgLossError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
